...
export const resources = {
  ...
  articles: {
    ...
    editLayout: "article",
    fields: [
      { key: "title", label: "Title", required: true, section: "Story" },
      {
        key: "slug",
        label: "Slug",
        required: true,
      ...
      { key: "date", label: "Publish date", type: "datetime", required: true, section: "Publish" },
      {
        key: "readTime",
        ...
        required: true,
        section: "Publish",
        hint: "Estimated minutes to read. Auto-calculated from the body (~200 words/min).",
      },
      {
        key: "author",
        label: "Author",
        required: true,
        section: "Details",
        hint: "Defaults to your account name when you create an article.",
      },
      { key: "image", label: "Cover image", type: "image", section: "Cover" },
      { key: "excerpt", label: "Excerpt", type: "textarea", rows: 3, section: "Story", hint: "Short intro under the title on the live article" },
      { key: "content", label: "Article body", type: "richtext", asArray: true, section: "Story", hint: "Infographic = image. Paste YouTube links for 16:9 video embeds." },
      { key: "published", label: "Published", type: "checkbox", section: "Publish" },
    ],
  },
  events: {
    path: "events",
  ...
  "event-albums": {
    ...
    hideCreate: true,
    hideDelete: true,
    editLabel: "Add photos",
    help: "Click Add photos on an album → upload new images → Save. Existing photos stay; new ones are added to the same album.",
    fields: [
      {
        key: "images",
        label: "Album photos",
        ...
        section: "Photos",
        span: "full",
        hint: "Add more anytime — new uploads are added to this album. Remove only if you want to delete a photo.",
      },
      {
        key: "name",
        label: "Album name",
        ...
        section: "Album",
        readOnlyOnEdit: true,
        hint: "Fixed album name (Open Day, Expo, etc.)",
      },
      {
        key: "key",
        label: "Key",
        ...
        section: "Album",
        readOnlyOnEdit: true,
        hint: "URL key — locked so the album stays the same",
      },
      { key: "sortOrder", label: "Sort order", type: "number", section: "Album", hint: "Lower numbers appear first" },
      { key: "published", label: "Published", type: "checkbox", section: "Album" },
    ],
  },
};
