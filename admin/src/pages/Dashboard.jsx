...
const CARDS = [
  ...
  { key: "event-albums", label: "Event Gallery", to: "/event-albums", tone: "violet", hint: "Album photos" },
...
function iconFor(key) {
  const paths = {
    ...
    "event-albums": "M4 5h6v6H4V5Zm10 0h6v6h-6V5ZM4 15h6v6H4v-6Zm10 0h6v6h-6v-6Z",
